    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item active">
                    <a href="#logout" type="button" class="sidebar-link bg-danger" data-bs-toggle="modal"
...
<!-- Modal logout -->
<div class="modal fade modal-borderless" id="logout" tabindex="-1" aria-labelledby="logoutLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-danger">
                <h1 class="modal-title fs-5 text-white" id="logoutLabel">Ready to leave ?</h1>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger"
                    onclick="event.preventDefault();document.querySelector('#formLogout').submit();">Logout</button>
            </div>
        </div>
    </div>
</div>